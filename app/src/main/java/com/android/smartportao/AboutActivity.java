...
public class AboutActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setWindowFlag(AboutActivity.this, WindowManager.LayoutParams.FLAG_FULLSCREEN, true);
        ...
        TextView mTitle = (TextView) toolbar.findViewById(R.id.toolbar_about_title);
