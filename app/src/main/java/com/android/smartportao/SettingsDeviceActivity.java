...
public class SettingsDeviceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setWindowFlag(SettingsDeviceActivity.this, WindowManager.LayoutParams.FLAG_FULLSCREEN, true);
        setContentView(R.layout.activity_settings_device);


        toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        TextView mTitle = (TextView) toolbar.findViewById(R.id.toolbar_device_settings_title);
